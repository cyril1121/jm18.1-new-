                           ...
                           )
{
  ...
  for (best_pos = 0, pos = p_Vid->start_me_refinement_hp; pos < max_pos2; pos++)
  {
    ...
    cand.scale[0]= mv->scale[0] + p_Vid->spiral_search[pos].scale[0];
    cand.offset[0]= mv->offset[0]+ p_Vid->spiral_search[pos].offset[0];
    cand.scale[1]= mv->scale[1] + p_Vid->spiral_search[pos].scale[1];
    cand.offset[1]= mv->offset[1]+ p_Vid->spiral_search[pos].offset[1];
    cand.scale[2]= mv->scale[2] + p_Vid->spiral_search[pos].scale[2];
    cand.offset[2]= mv->offset[2]+ p_Vid->spiral_search[pos].offset[2];
