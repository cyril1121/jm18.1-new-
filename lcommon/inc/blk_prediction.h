...
extern void sample_reconstruct_p4x4forzero (Macroblock *currMB,int block,int bx,int by,imgpel **curImg, imgpel **mpr,  int mb_x, int opix_x, int width, int height);
